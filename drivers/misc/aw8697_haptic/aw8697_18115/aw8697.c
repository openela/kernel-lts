 ...
 *
 ******************************************************/
#define AW8697_I2C_NAME "aw8697_haptic_18115"
#define AW8697_HAPTIC_NAME "awinic_haptic_18115"
...
static int aw8697_haptic_stop_delay(struct aw8697 *aw8697)
{
    ...
    while(cnt--) {
        ...
        pr_info("%s wait for standby, reg glb_state=0x%02x, cnt = %d\n",  __func__, reg_val, cnt);
        mdelay(2);
    }
        ...
        char *buf)
{
    ...
    for(i = 0; i < AW8697_REG_MAX; i ++) {
        if(!(aw8697_reg_access_18115[i]&REG_RD_ACCESS))
           continue;
        ...
        char *buf)
{
    ...
    pr_debug("aw8697_osc_cali_show: 2018_microsecond:%ld \n",aw8697->microsecond);
...
static struct of_device_id aw8697_dt_match[] = {
    { .compatible = "awinic,aw8697_haptic,18115" },
    { },
};
