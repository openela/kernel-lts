 ...
 *
 ******************************************************/
#define AW8697_I2C_NAME "aw8697_haptic_19081"
#define AW8697_HAPTIC_NAME "awinic_haptic_19081"
        ...
        unsigned char wav, unsigned char loop)
{
    ...
    if(wav%2) {
        tmp = loop<<0;
        aw8697_i2c_write_bits(aw8697, AW8697_REG_WAVLOOP1+(wav >> 1),
        ...
        char *buf)
{
    ...
    for(i = 0; i < AW8697_REG_MAX; i ++) {
        if(!(aw8697_reg_access_19081[i]&REG_RD_ACCESS))
           continue;
