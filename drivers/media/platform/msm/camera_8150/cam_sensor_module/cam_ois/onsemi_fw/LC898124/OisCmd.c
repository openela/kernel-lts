...
void	SetSinWavePara( UINT8 UcTableVal ,  UINT8 UcMethodVal )
{
	...
	if( UlFreqDat == 0xFFFFFFFF )			/* Sine�g���~ */
	{
		...
		SetTransDataAdr124( SinWave_OutAddr	,	0x00000000 ) ;		// �o�͐�A�h���X
		SetTransDataAdr124( CosWave_OutAddr	,	0x00000000 );		// �o�͐�A�h���X
		...
		RamWrite32A( SinWaveC_Regsiter	,	0x00000001 ) ;									// Sine Wave Start
		SetTransDataAdr124( SinWave_OutAddr	,	(UINT32)HALL_RAM_HXOFF1 ) ;		// �o�͐�A�h���X
		SetTransDataAdr124( CosWave_OutAddr	,	(UINT32)HALL_RAM_HYOFF1 ) ;		// �o�͐�A�h���X
