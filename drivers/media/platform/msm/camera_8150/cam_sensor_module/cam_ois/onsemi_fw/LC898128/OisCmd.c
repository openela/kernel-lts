...
TRACE("TnePtp\n") ;
	...
	SetSinWavGenInt();
	SetTransDataAdr( SinWave_OutAddr	,	SinWave_Output ) ;		// �o�͐�A�h���X
	SetTransDataAdr( CosWave_OutAddr	,	CosWave_OutAddr );		// �o�͐�A�h���X
...
#define		ZG_MRGN		(409 << 16)					// G tolerance  100mG�Ƃ���
UINT_32	MeasGyAcOffset(  void  )
{
	UINT_32	UlRsltSts;
	INT_32			SlMeasureParameterA , SlMeasureParameterB ;
